...
namespace GardenTracker.Data.Migrations
{
    ...
    [Migration("20260628220545_AddImageUrlToPlantVarieties")]
    partial class AddImageUrlToPlantVarieties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GardenTracker.Core.Entities.BedPlanting", b =>
                {
                    ...
                    b.Property<int?>("QuantityUsedFromInventory")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GardenTracker.Core.Entities.InventoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GardenTracker.Core.Entities.PlantType", b =>
                {
                    ...
                    b.Property<int?>("SpacingInches")
                        .HasColumnType("int");

                    b.Property<string>("SunPreference")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GardenTracker.Core.Entities.BedPlanting", b =>
                {
                    ...
                    b.HasOne("GardenTracker.Core.Entities.InventoryItem", "InventoryItem")
                        .WithMany("Plantings")
