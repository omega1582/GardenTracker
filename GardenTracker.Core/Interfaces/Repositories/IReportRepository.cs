...
public interface IReportRepository
{
    ...
    Task<IEnumerable<BedExpenseTotal>> GetBedExpenseTotalsAsync(int gardenId, int year);
    Task<IEnumerable<BedHarvestLine>> GetBedHarvestLinesAsync(int gardenId, int year);
}
